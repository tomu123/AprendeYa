...
ActiveRecord::Schema.define(version: 2022_02_07_071949) do
...
#   Unknown type 'activity_type' for column 'activity_type'
  ...
  create_table "solutions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["activity_id"], name: "index_solutions_on_activity_id"
    t.index ["enrollment_id"], name: "index_solutions_on_enrollment_id"
  end
